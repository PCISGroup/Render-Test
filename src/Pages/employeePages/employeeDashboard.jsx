...
const EmployeeDashboard = () => {
  ...
  }, [showCancellationDetails, stateDropdownOpen]);
        ...
        <div className="schedule-header">
          <div className="view-controls">
            <div className="view-tabs">
              <button
                className={`view-tab ${viewType === "day" && isToday(currentDate) ? "active" : ""}`}
                onClick={() => {
                  setCurrentDate(new Date());
                  setViewType("day");
                  setIsStatusDropdownOpen(true);
              ...
              <button
                className={`view-tab ${viewType === "day" && isToday(subDays(currentDate, 1)) ? "active" : ""}`}
                onClick={() => {
